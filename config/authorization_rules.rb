...
authorization do
  ...
  role :member do
    ...
    has_permission_on :members_projectiles, :to => [:create, :my_projectiles, :my_favorites]
  ...
  role :administrator do
    ...
    has_permission_on :members_projectiles, :to => [:manage, :my_projectiles, :my_favorites]
